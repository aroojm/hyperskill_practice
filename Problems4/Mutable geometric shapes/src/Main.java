...
final class Circle implements MutableShape{
    ...
    public void scale(float factor){radius = radius * factor;}
    public void move(float dx, float dy){centerX += dx; centerY += dy;}
}
...
final class Rectangle implements MutableShape{
    ...
    public void scale(float factor){width *= factor; height *= factor;}
